...
class KwikSliderMeta extends KwikSlider {
	...
	public function save_ks_meta($post_id, $post) {
		...
		$ks_slides = array(
			'ks_slides' => $slide_ids,
			'ks_slider_settings' => $_POST['ks_slider_settings'],
			'ks_pager_settings' => $_POST['ks_pager_settings'],
		);
